...
--
-- Dumping data for table `entidade_servico`
--

LOCK TABLES `entidade_servico` WRITE;
/*!40000 ALTER TABLE `entidade_servico` DISABLE KEYS */;
/*!40000 ALTER TABLE `entidade_servico` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `grupo_utilizador`
--

LOCK TABLES `grupo_utilizador` WRITE;
/*!40000 ALTER TABLE `grupo_utilizador` DISABLE KEYS */;
/*!40000 ALTER TABLE `grupo_utilizador` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `grupo_utilizador_permissao`
--

LOCK TABLES `grupo_utilizador_permissao` WRITE;
/*!40000 ALTER TABLE `grupo_utilizador_permissao` DISABLE KEYS */;
/*!40000 ALTER TABLE `grupo_utilizador_permissao` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `tipo_entidade` WRITE;
/*!40000 ALTER TABLE `tipo_entidade` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipo_entidade` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-06-09  2:04:41
